...
class AlertUi {
	...
	public static function getError(string $fqn): mixed {
		...
		return match($fqn) {
			...
			'User::email.duplicate' => s("Vous ne pouvez pas utiliser cette adresse e-mail, car elle a déjà utilisée pour s'inscrire sur {siteName} (<link>mot de passe oublié ?</link>).", ['link' => '<a href="/user/log:forgottenPassword" target="_blank">']),
